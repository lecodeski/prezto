# Generated by Powerlevel10k configuration wizard on 2024-04-29 at 19:28 CEST.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 64531.
...
() {
  ...
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_ICON="$(print_icon 'VCS_UNTRACKED_ICON') "
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_PROD_FOREGROUND=10
  typeset -g POWERLEVEL9K_KUBECONTEXT_PROD_BACKGROUND=1
  typeset -g POWERLEVEL9K_KUBECONTEXT_PROD_CONTENT_EXPANSION='$(print_icon 'PUBLIC_IP_ICON') ${P9K_KUBECONTEXT_NAME}'

  typeset -g POWERLEVEL9K_KUBECONTEXT_TEST_FOREGROUND=0
  typeset -g POWERLEVEL9K_KUBECONTEXT_TEST_BACKGROUND=11
  typeset -g POWERLEVEL9K_KUBECONTEXT_TEST_CONTENT_EXPANSION='$(print_icon 'TEST_ICON') ${P9K_KUBECONTEXT_NAME}'

  typeset -g POWERLEVEL9K_KUBECONTEXT_PLUTOS_FOREGROUND=0
  typeset -g POWERLEVEL9K_KUBECONTEXT_PLUTOS_BACKGROUND=15
  typeset -g POWERLEVEL9K_KUBECONTEXT_PLUTOS_CONTENT_EXPANSION='$(print_icon 'TOOLBOX_ICON') ${P9K_KUBECONTEXT_NAME}'

  typeset -g POWERLEVEL9K_KUBECONTEXT_CLASSES=(
      '*prod*'   PROD     # These values are examples that are unlikely
      '*stage*'  TEST     # to match your needs. Customize them as needed.
      '*test*'   TEST
      '*plutos*' PLUTOS
      '*'        DEFAULT)
